...
const devnetConfig = __importStar(require("./devnet.json"));
exports.devnetConfig = devnetConfig;
const betaConfig = __importStar(require("./beta.json"));
exports.betaConfig = betaConfig;
const productionConfig = __importStar(require("./production.json"));
